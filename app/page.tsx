            ...
            <div className="mt-8 grid grid-cols-3 gap-6">
              {[
                ...
                <div key={stat.label} className="motion-scale-in motion-ready interactive-element" data-stagger={i + 1}>
                  <div className="text-terracotta font-semibold text-2xl">{stat.num}</div>
      ...
      <section id="rooms" className="py-16 md:py-24 bg-cream-light">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 motion-fade-up motion-ready">
            ...
            <Link href="/rooms" className="text-terracotta font-semibold text-sm inline-flex items-center gap-2 hover:gap-3 transition-all interactive-element">
              View all 9 rooms
          ...
          <div className="order-2 md:order-1 motion-fade-left motion-ready">
            ...
            <ul className="mt-6 space-y-3 text-sm text-ink">
              {["Up to 50 guests seated or cocktail", "Catering packages from R150 pp", "On-site accommodation for your guests", "Confirmed pricing — no surprises"].map((item, i) => (
                <li key={item} className="flex items-start gap-3 motion-fade-up motion-ready" data-stagger={i + 1}><span className="text-gold font-bold">✓</span> {item}</li>
              ))}
            </ul>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { icon: "M21 12V7H5a2 2 0 0 1 0-4h14v4M3 5v14a2 2 0 0 0 2 2h16v-5M18 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4z", title: "Cash on Arrival", desc: "Perfect for leisure guests. Settle in person at check-in — no advance payment required.", bg: "bg-terracotta-tint", color: "text-terracotta" },
              { icon: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8", title: "Proof of Payment", desc: "Upload your POP directly through your booking confirmation and we'll mark it verified on your record.", bg: "bg-gold-tint", color: "text-gold" },
            ].map((p, i) => (
